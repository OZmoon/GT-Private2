...
string CacheIP = "ubistatic-a.akamaihd.net";
string sip = "";
string suser = "";
string spass = "";
...
map<int, bool> four_punch;
map<int, bool> five_punch;
map<int, bool> triple_place;
map<int, bool> four_place;
map<int, bool> five_place;
...
inline int getPlayersCountInServer()
{
	int count = 0;
