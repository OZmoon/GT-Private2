...
void InputTextRenderComponent::OnAdd(Entity *pEnt)
{
	...
	m_pFontID = &GetVarWithDefault("font", uint32(1))->GetUINT32();
...
void InputTextRenderComponent::OnRender(VariantList *pVList)
{
	...
	{
		DrawRect(vFinalPos, *m_pSize2d, borderCol, 0.5);
	}
	...
	if (*m_pHasFocus)
	{
		...
		CL_Rectf r = CL_Rectf(vCursorPos.x, vCursorPos.y, vCursorPos.x+0.7, vCursorPos.y+height-2.5); 
